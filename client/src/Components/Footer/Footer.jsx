...
function Footer() {
  return (
    <div className='overflow-x-hidden text-white bg-black h-screen  '>
      <div className='mt-[3rem] ml-2 bg-black '>
        <input className='ml-2 pl-2 cursor-default bg-black border h-[2.4rem] ' type="email" placeholder='E-mail' />
        <button className='ml-2 text-lg font-bold hover:bg-blue-900 bg-blue-500 rounded-md h-[2.5rem] w-[5rem]'>Submit</button>
      </div>
      <div>
        <div className='mt-[-2rem] flex justify-center bg-black'>
      ...
      <div className='bg-black'>
        <p className='mt-[1.5rem] ml-5 bg-black cursor-pointer max-w-[30rem]'>the use of non-fungible tokens (NFTs) to create a cooperative atmosphere for content creation, where NFT holders fund the project and contribute to the direction and narrative of the story</p>
      </div>
      <div className='ml-[25rem] bg-black gap-[5rem] flex justify-center'>
        <div className='mt-[-8rem] bg-black'>
